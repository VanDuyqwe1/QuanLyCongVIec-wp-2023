...
function twenty_twenty_one_widgets_init()
{
	...
	register_sidebar(
		array(
			'name'          => esc_html__('Prev-Next', 'twentytwentyone'),
			'id'            => 'sidebar-prev-next',
			'description'   => esc_html__('Add widgets here to appear in your Prev-Next.', 'twentytwentyone'),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Last posts', 'twentytwentyone' ),
			'id'            => 'sidebar-last-posts',
			'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'twentytwentyone' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
